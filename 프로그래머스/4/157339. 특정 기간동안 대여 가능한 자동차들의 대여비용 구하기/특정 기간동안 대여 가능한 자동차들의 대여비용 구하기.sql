...
where d.CAR_TYPE = c.CAR_TYPE and d.DURATION_TYPE = '30일 이상' and 500000 <= c.DAILY_FEE * 30 *(1-d.DISCOUNT_RATE/100) and c.DAILY_FEE * 30 *(1-d.DISCOUNT_RATE/100) < 2000000
